...
$eit0_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit0.xml"));
$eit1_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit1.xml"));
$eit2_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit2.xml"));
$eit3_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit3.xml"));
$eit4_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit4.xml"));
$eit5_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit5.xml"));
$eit6_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit6.xml"));
$eit7_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit7.xml"));

$ett0_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett0.xml"));
$ett1_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett1.xml"));
$ett2_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett2.xml"));
$ett3_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett3.xml"));
$ett4_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett4.xml"));
$ett5_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett5.xml"));
$ett6_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett6.xml"));
$ett7_size = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett7.xml"));
...
$xmlFilePath = '/var/www/html/transports/' . $transportName . '/' . $transportName . '_stt.xml';
...
// echo $udpaddress;
     ...
     $command = "/usr/bin/sudo -i nohup /root/tsduck/tsduck/bin/release-x86_64-testmodulator/tsp -vvvvvv --control-local 127.0.0.1 --control-port " . $ctl_port . " --bitrate 1000000 -I null -P regulate ";
    
    $command .= "-P inject --bitrate 300000 -p 8187 /var/www/html/transports/$transportName/" . $transportName . "_stt.xml=100 -P regulate ";

    $command .= "-P inject --bitrate 300000 -p 7424 /var/www/html/transports/$transportName/" . $transportName . "_eit0.xml=100 -P regulate ";
    $command .= "-P inject --bitrate 300000 -p 7425 /var/www/html/transports/$transportName/" . $transportName . "_eit1.xml=100 -P regulate ";
    $command .= "-P inject --bitrate 300000 -p 7426 /var/www/html/transports/$transportName/" . $transportName . "_eit2.xml=100 -P regulate ";
    $command .= "-P inject --bitrate 300000 -p 7427 /var/www/html/transports/$transportName/" . $transportName . "_eit3.xml=100 -P regulate ";
    $command .= "-P inject --bitrate 300000 -p 7428 /var/www/html/transports/$transportName/" . $transportName . "_eit4.xml=100 -P regulate ";
    $command .= "-P inject --bitrate 300000 -p 7429 /var/www/html/transports/$transportName/" . $transportName . "_eit5.xml=100 -P regulate ";
    $command .= "-P inject --bitrate 300000 -p 7430 /var/www/html/transports/$transportName/" . $transportName . "_eit6.xml=100 -P regulate ";
    $command .= "-P inject --bitrate 300000 -p 7431 /var/www/html/transports/$transportName/" . $transportName . "_eit7.xml=100 -P regulate ";


    $command .= "-P inject --bitrate 300000 -p 7680 /var/www/html/transports/$transportName/" . $transportName . "_ett0.xml=1000 -P regulate ";
    $command .= "-P inject --bitrate 300000 -p 7681 /var/www/html/transports/$transportName/" . $transportName . "_ett1.xml=1000 -P regulate ";
    $command .= "-P inject --bitrate 300000 -p 7682 /var/www/html/transports/$transportName/" . $transportName . "_ett2.xml=1000 -P regulate ";
    $command .= "-P inject --bitrate 300000 -p 7683 /var/www/html/transports/$transportName/" . $transportName . "_ett3.xml=1000 -P regulate ";
    $command .= "-P inject --bitrate 300000 -p 7684 /var/www/html/transports/$transportName/" . $transportName . "_ett4.xml=1000 -P regulate ";
    $command .= "-P inject --bitrate 300000 -p 7685 /var/www/html/transports/$transportName/" . $transportName . "_ett5.xml=1000 -P regulate ";
    $command .= "-P inject --bitrate 300000 -p 7686 /var/www/html/transports/$transportName/" . $transportName . "_ett6.xml=1000 -P regulate ";
    $command .= "-P inject --bitrate 300000 -p 7687 /var/www/html/transports/$transportName/" . $transportName . "_ett7.xml=1000 -P regulate ";
...
$ctl_port = $config['OUTPUT']['control_port'];
    ...
    $command = "/usr/bin/sudo -i nohup /root/tsduck/tsduck/bin/release-x86_64-testmodulator/tspcontrol --tsp 127.0.0.1:" . $ctl_port . " restart -s $pluginIndex";
echo $command;
...
function handleVersionFile($ts) {
    $filename = '/var/www/html/transports/' . $ts . '/version.txt';
// echo $filename;
...
while (true) {
  ...
  // usleep(500000);
				...
				// Check if it's time to run the 12-hour commands
   				 ...
   				 $command = "/usr/bin/sudo /usr/bin/nohup /usr/bin/php /var/www/html/epg_gen.php $ts_name $version >/dev/null 2>&1 & echo $!";
   				 exec($command);
...
$GLOBALS['eit0_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit0.xml"));
$GLOBALS['eit1_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit1.xml"));
$GLOBALS['eit2_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit2.xml"));
$GLOBALS['eit3_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit3.xml"));
$GLOBALS['eit4_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit4.xml"));
$GLOBALS['eit5_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit5.xml"));
$GLOBALS['eit6_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit6.xml"));
$GLOBALS['eit7_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_eit7.xml"));

$GLOBALS['ett0_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett0.xml"));
$GLOBALS['ett1_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett1.xml"));
$GLOBALS['ett2_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett2.xml"));
$GLOBALS['ett3_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett3.xml"));
$GLOBALS['ett4_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett4.xml"));
$GLOBALS['ett5_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett5.xml"));
$GLOBALS['ett6_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett6.xml"));
$GLOBALS['ett7_size'] = formatFileSize(filesize("/var/www/html/transports/" . $ts_name . "/" . $ts_name . "_ett7.xml"));
