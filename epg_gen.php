...
$eitXmlData .= '</tsduck>';
    ...
    $eitOutputFilePath = "/var/www/html/transports/{$transportName}/{$transportName}_eit{$i}.xml";
    $ettOutputFilePath = "/var/www/html/transports/{$transportName}/{$transportName}_ett{$i}.xml";
